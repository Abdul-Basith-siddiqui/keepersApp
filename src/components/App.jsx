      ...
      {notes.map((notesObj, index) => {
        ...
        return (
          <Note
            ...
            id={index} // same
            title={notesObj.title} //tapping into the obj and getting title storing into title (custom attribute)
            content={notesObj.content} //tapping into the obj and getting title storing into content (custom attribute)
